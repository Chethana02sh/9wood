...
//	@FindBy(xpath = "//td[contains(.,'Sales Stage')]/..//div[@id='s2id_autogen15']//span[.='Select an Option']")private WebElement selesStageDropdown;
	...
	public void selectCnt(WebDriver driver,String orgName,String opptyName,String campName) throws InterruptedException
	{
		...
		Point loc = campaignLookupImg.getLocation();
		int x = loc.getX();
		int y = loc.getY();
